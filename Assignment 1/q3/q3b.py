...
plt.scatter(x1, y1, c='black', label="y = 0")
plt.scatter(x2, y2, c='red', label = "y = 1")
plt.xlabel("Normalized x1")
plt.xlabel("Normalized x2")
plt.title('Logistic Regression (black dots : 0 red dots : 1)')
plt.legend()
plt.savefig(args[2]+"/sampledata3.png")
plt.clf()
plt.scatter(x1, y1, c='black', label="y = 0")
plt.scatter(x2, y2, c='red', label="y = 1")
plt.xlabel("Normalized x1")
...
plt.plot(X[:, 1], y_plot, label="decision boundary")
plt.legend()
