...
plt.ylabel('$theta_1$')
plt.scatter(alltheta[:, 0], alltheta[:,1], s =2)
plt.title("contour for error function at learning rate : 0.025")
plt.savefig(args[2]+"/contour2.png")
plt.clf()
...
plt.ylabel('$theta_1$')
plt.scatter(alltheta[:, 0], alltheta[:,1], s =2)
plt.title("contour for error function at learning rate : 1")
plt.savefig(args[2]+"/contour3.png")
plt.clf()
