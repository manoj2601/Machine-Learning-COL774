...
# print("total num of times, J(theta) computed : ", t1-1)
# print("epoch : ", epoch1)
...
# print("total num of times, J(theta) computed : ", t2-1)
# print("epoch : ", epoch2)
...
# alltheta3, epoch3, t3 = gradientDescent(X, Y, theta3, alpha, iterations, r, totalBatches, 0.1, 0.1, 6)
# print("total num of times, J(theta) computed : ", t3-1)
# print("epoch : ", epoch3)
...
# print(f"Initial cost : {cost}")
# print(f"Learning Rate : {alpha}")
# alltheta4, epoch4, t4 = gradientDescent(X, Y, theta4, alpha, iterations, r, totalBatches, 0.01, 0.01, 50)
# print("total num of times, J(theta) computed : ", t4-1)
# print("epoch : ", epoch4)
